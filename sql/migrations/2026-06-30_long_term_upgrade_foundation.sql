-- Long-term upgrade foundation for device reservation and management.
-- This migration is intentionally additive and compatible with the current reservations-based app.
...
VALUES ('block_ip_access_enabled', '0', 'Whether public pages and login challenge are blocked when accessed by IP host')
