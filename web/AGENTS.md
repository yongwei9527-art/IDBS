...
- access token 存储在 localStorage：`laboratory-management-system.access_token`；refresh token 使用 HttpOnly Cookie，401 自动触发一次 refresh-retry。
